...
<div class="border border-warning smtp_block">
  ...
  <?php if (!EnvIsSet('DISABLE_SMTP','','false')){ echo '<button type="submit" formaction="postwizard.php" name="submit_post" value="submit_2" class="btn btn-primary"'. RecaptchaElement(EnvIsSet('GR_SITE_KEY','','')).'>'.ini_local($l10n_file, $L10N_CODE, "Mail to"). '</button>'; } ?>
</form>
</div>
