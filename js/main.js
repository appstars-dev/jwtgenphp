...
const namesByLang = {
    ...
    ru: {
        male: {
            ...
            patronymic: [
                ...
                'Данилович', 'Егорович', 'Матвеевич', 'Романович', 'Владимирович', 'Ярославович',
                'Фёдорович', 'Глебович', 'Константинович', 'Павлович', 'Николаевич', 'Тимофеевич',
                'Георгиевич', 'Львович', 'Петрович', 'Денисович', 'Владиславович', 'Антонович',
                'Борисович', 'Иванович', 'Олегович', 'Русланович', 'Витальевич', 'Викторович',
                'Григорьевич', 'Евгеньевич', 'Игоревич', 'Леонидович', 'Семёнович', 'Степанович',
                'Тихонович', 'Филиппович', 'Эдуардович', 'Юрьевич', 'Захарович', 'Миронович',
                'Давидович', 'Артурович', 'Арсеньевич', 'Святославович', 'Всеволодович',
                'Платонович', 'Демьянович', 'Елисеевич', 'Лаврентьевич', 'Макарович', 'Назарович',
                'Остапович', 'Родионвич', 'Савельевич', 'Тарасович', 'Устинович', 'Харитонович',
                'Чеславович', 'Адамович', 'Альбертович', 'Анатольевич', 'Брониславович',
                'Вадимович', 'Валентинович', 'Валерианович', 'Вениаминович', 'Германович',
                'Гордеевич', 'Еремеевич', 'Зиновьевич', 'Иннокентиевич', 'Казимирович',
                'Климович', 'Кузьмич', 'Любомирович', 'Мартинович', 'Мечиславович', 'Моисеевич',
                'Несторович', 'Никанорович', 'Никодимович', 'Орестович', 'Панкратович',
                'Парамонович', 'Прохорович', 'Ратмирович', 'Ростиславович', 'Севастьянович',
                'Симонович', 'Соломонович', 'Трифонович', 'Федотович', 'Фомич', 'Эрнестович',
                'Юлианович', 'Яковлевич'
            ]
        },
        female: {
    ...
    // Сюда можно добавить другие языки, например: 'en': { ... }
};
...
function generateRandomFullName(langCode = 'ru') {
    const data = namesByLang[langCode];
    if (!data) {
        throw new Error(`Language "${langCode}" Is not supported. Available: ${Object.keys(namesByLang).join(', ')}`);
    }
 ...
 */
function generateRandomFullNames(count, langCode = 'ru') {
    const result = [];
